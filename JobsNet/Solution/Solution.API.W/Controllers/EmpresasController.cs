...
namespace Solution.API.W.Controllers
{
    ...
    public class EmpresasController : ControllerBase
    {
        ...
        // GET: api/Empresas/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Empresas>> GetEmpresas(decimal id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutEmpresas(decimal id, Empresas empresas)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Empresas>> DeleteEmpresas(decimal id)
        {
            var empresas = await _context.Empresas.FindAsync(id);
            if (empresas == null)
            {
        ...
        private bool EmpresasExists(decimal id)
        {
